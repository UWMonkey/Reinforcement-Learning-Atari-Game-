...
ENV_NAME = 'DemonAttack-v0'  # Environment name
...
INITIAL_REPLAY_SIZE = 20000  #20000 Number of steps to populate the replay memory before training starts
...
SAVE_INTERVAL = 800000  # The frequency with which the network is saved
NO_OP_STEPS = 10  # Maximum number of "do nothing" actions to be performed by the agent at the start of an episode
LOAD_NETWORK = False
TRAIN = True
SAVE_NETWORK_PATH = 'D:/MMAI/SAVE_NETWORK_PATH/' + ENV_NAME #+ '/DemonAttack-R2'
SAVE_SUMMARY_PATH = 'D:/MMAI/SAVE_SUMMARY_PATH/' + ENV_NAME
NUM_EPISODES_AT_TEST = 30  # Number of episodes the agent plays at test time

#model_checkpoint_path: "D:/MMAI/SAVE_NETWORK_PATH/DemonAttack-v0/
...
class Agent():
    ...
    def build_network(self):
        model = Sequential()
        model.add(Conv2D(32, (8, 8), subsample=(4, 4), activation='relu', input_shape=(STATE_LENGTH, FRAME_WIDTH, FRAME_HEIGHT),data_format='channels_first'))
